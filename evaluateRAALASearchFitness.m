function J = evaluateRAALASearchFitness(x, param2path, t_start, hasPayload, costModel, env, cfg)
% evaluateRAALASearchFitness — 搜索阶段内部适应度函数
%
% 设计原则:
...
% 的候选仍会获得更低的 internal_J, 优化器仍能正确排序.
    ...
    %       对段内子采样违规才累加, 但 evaluateRAALASearchFitness 的路径点只有 ~10 个,
