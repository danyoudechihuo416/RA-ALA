...
titles = {'Composite Score', 'Energy', 'Flight Time', ...
          'Dynamic Risk', 'Constraint Penalty'};
ylabels = {'Composite Score, J', 'Energy, E (Wh)', 'Flight Time, T (s)', ...
           'Dynamic Risk, R', 'Constraint Penalty, P'};
useLog = [true false false true true];
formats = {'%.2f','%.2f','%.1f','%.3f','%.3f'};
xlabels = {'Full','No smooth. guidance','No headwind guidance','No Top-K stage'};
...
legendNames = {'Full RA-ALA','No smoothness guidance', ...
    'No headwind-exposure guidance','No Top-K candidate stage'};
legendDescriptions = {'complete method', ...
    'search smoothness term removed; path variants retained', ...
    'three headwind look-ahead queries set to zero', ...
    'internal-best raw path; no candidate re-evaluation or selection'};
