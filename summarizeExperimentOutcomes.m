function summarizeExperimentOutcomes()
% Re-evaluate the fixed Section 5.5 paths without rerunning any planner.

projectDir = fileparts(mfilename('fullpath'));
S = load(fullfile(projectDir,'main_experiment_cohort.mat'));
outDir = fullfile(projectDir,'experiment_outcome_summary');
...
save(fullfile(outDir,'experiment_outcome_summary.mat'),'counts','joint','caseTable');
