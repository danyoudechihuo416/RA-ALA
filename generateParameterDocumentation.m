%% generateParameterDocumentation.m
%% =========================================================================
%%  RA-ALA 参数文档生成器
%%  运行方式: 在 MATLAB 中执行 generateParameterDocumentation
%%  输出文件: RA_ALA_参数文档.txt (纯文本，可用任意编辑器查看)
%%           RA_ALA_参数文档.html (网页格式，浏览器打开)
%%
%%  文档涵盖六大参数类别:
%%    1. 全局实验参数       (runRA_ALA.m)
%%    2. ALA 算法参数       (runRA_ALA.m → runRA_ALA)
%%    3. 统一代价函数参数   (UnifiedCostModel.m)
%%    4. 无人机物理参数     (UnifiedCostModel.m)
%%    5. 城市环境参数       (CityEnvironment.m)
%%    6. 二次救援参数       (runRA_ALA.m v10)
%% =========================================================================
...
%% ==================== 读取当前代码中的实际参数值 ====================
%% （与 runRA_ALA.m / UnifiedCostModel.m / CityEnvironment.m 保持同步）
...
p_topK           = 5;      % Top-K 候选数
p_riskWeight_cfg = 15.0;   % cfg.riskWeight (evaluateRAALASearchFitness 内部)
...
% evaluateRAALASearchFitness 内部惩罚参数
...
p_eval_nsub      = 4;      % evaluateRAALASearchFitness段级子采样数
% Smooth / Repair 路径参数
...
W(sprintf('  生成脚本: generateParameterDocumentation.m'));
W('');

%% --- 类别1 ---
W('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
W('  【1】全局实验参数   (runRA_ALA.m)');
W('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
...
%% --- 类别2 ---
W('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
W('  【2】ALA 算法参数   (runRA_ALA.m → runRA_ALA / evaluateRAALASearchFitness)');
W('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
W('  ---- 2.1 种群与迭代 ----');
...
W(sprintf('  %-30s = %-12.1f  %% cfg.riskWeight (evaluateRAALASearchFitness内部)', 'ala_cfg.riskWeight', p_riskWeight_cfg));
...
W('');
W('  ---- 2.5 evaluateRAALASearchFitness 内部惩罚参数 ----');
...
W(sprintf('  %-30s = %-12d  %% evaluateRAALASearchFitness段级子采样数', 'EVAL_NSUB', p_eval_nsub));
W('');
W('  ---- 2.6 三路径生成参数 ----');
...
%% --- 类别6 ---
W('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
W('  【6】二次救援 v10 参数   (runRA_ALA.m → 定向二次救援 v10)');
W('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
...
W('');
W('  文件来源对照:');
W('    runRA_ALA.m    → 类别1,2,6  (全局参数/ALA算法/救援机制)');
...
sections = {
    ...
    'ALA种群与搜索参数', 'runRA_ALA.m → runRA_ALA', ...
...
WH('<p style="color:#6c7086;font-size:11px">文件来源: runRA_ALA.m (全局/ALA/救援) | UnifiedCostModel.m (代价/物理) | CityEnvironment.m (环境/风场)</p>');
WH('</body></html>');
fclose(fh);
