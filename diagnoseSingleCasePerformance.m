...
for si = 1:3
    ...
    fprintf('  │  scene_entry       = %8.6f  → J贡献 %7.3f\n', d.penalty_scene_entry, 100*d.penalty_scene_entry);
...
if J_pen_contribution > 0.5 * final_det.J_final
    ...
    [~, pen_order] = sort([ ...
        ...
        final_det.penalty_scene_entry, ...
        final_det.penalty_battery], 'descend');
    pen_names = {'penalty_height', 'penalty_static', 'penalty_scene_entry', 'penalty_battery'};
    pen_vals  = [final_det.penalty_height, final_det.penalty_static_collision, ...
                 final_det.penalty_scene_entry, final_det.penalty_battery];
